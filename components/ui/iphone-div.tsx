...
export type IphoneProps = HTMLAttributes<HTMLDivElement>;

export function IphoneDiv({
  className,
  style,
  children,
  ...props
  ...
  return (
    ...
    >
      {/* ✅ หน้าจอจริง */}
      <div
        className={cn(`absolute overflow-auto`)}
        style={{
          left: `${LEFT_PCT}%`,
          top: `${TOP_PCT + 8}%`,
          width: `${WIDTH_PCT}%`,
          height: `${HEIGHT_PCT - 12.5}%`,
      ...
      >
        ...
        <path
          ...
          className="fill-white stroke-[#fff] stroke-[1]"
        />
